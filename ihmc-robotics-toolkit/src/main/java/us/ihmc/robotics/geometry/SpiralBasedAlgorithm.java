...
public class SpiralBasedAlgorithm
{
   ...
   public static Point3D[] generatePointsOnSphere(Point3DBasics sphereOrigin, double sphereRadius, int numberOfPointsToGenerate)
   {
    ...
    * This algorithm can be found in the paper: "Distributing Many Points on a Sphere" by E.B. Saff and B.J. Kuijlaars. (PDF version was on Google on the 02/13/2015).
    */
   public static Point3D[] generatePointsOnSphere(Point3DBasics sphereOrigin, double sphereRadius, int numberOfPointsToGenerate, double deltaN)
   {
